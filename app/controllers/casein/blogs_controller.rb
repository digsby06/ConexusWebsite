  ...
  class BlogsController < Casein::CaseinController
    ...
    def index
      @casein_page_title = 'Blogs'
  		@blogs = Blog.order(sort_order(:post_title)).paginate :page => params[:page]
    end
    ...
    private
      ...
      def blog_params
        params.require(:blog).permit(:post_title, :entry, :author, :category, :published_at, :published, :hero)
      end
